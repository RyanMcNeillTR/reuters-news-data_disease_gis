...
No further information in other sources, but have not located a comprehensive case list for 2015 from IEDCR so this is perhaps not surprising.
...
bgd_114 <- bgd_gadm_3 %>% filter(str_detect(name_3, "Muksudpur")) %>%
  grab_polygon(114)
