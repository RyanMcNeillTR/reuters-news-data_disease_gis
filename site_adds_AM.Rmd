...
bgd_112 <- bgd_gadm_3 %>% filter(str_detect(name_3, "Shibalaya")) %>%
  grab_polygon(112)

bgd_113 <- bgd_gadm_3 %>% filter(str_detect(name_3, "Ghior")) %>%
  grab_polygon(113)
...
[This](https://www.thenewhumanitarian.org/news/2013/02/05/fresh-outbreak-nipah-virus-bangladesh) news story notes that the Dhaka cases coded earlier, bgd_24, came from sap coillected in from Mymensingh. 
As there is no further reporting on spillovers in this district, not coding again.
