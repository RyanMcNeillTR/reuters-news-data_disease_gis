...
st_layers("./input_data/Philippines/stanford_level_3")
...
temp_point <- tribble(~latitude, ~longitude, 11.26178, 75.96031) %>%
...
Again for bgd_117, a viral sequence is listed as a primary case in a 25 year old male in Rahman et al 2021, [here](https://www.sciencedirect.com/science/article/pii/S1201971220322451#tbl0020). District is Naogaon and subdistrict Manda. But the sample is from January 2015, not May. 
...
Note this spillover is early 2013; added spillover bgd_112 is a separate event reported in December, the next season.
