...
ind_taluks <- st_read("./input_data/India/Kerala/gadm36_IND.gpkg",
                      layer = "gadm36_IND_3") %>%
              janitor::clean_names()
...
ind_7 <- data.frame(poly_geom = NA,
                    point_geom = st_point(c(10.17222, 76.21215)),
                    precision = "point",
                    reuters_id = 7,
                    country_iso = "IND")
...
Perambra is a town in Kozhikode district, about an hour north of the city of Kozhikode. 



ind_gadm_3 %>% str

ind_gadm_3 %>% filter(str_detect(name_3, "Kozhikode")) 
